...
%                            \draw [->] (input-\i) -- node [sloped, above, near start] {$w_{\n,\m}$} (hidden-\j); 
                    ...
                    \draw [->] (input-2) -- node [sloped, below, pos=0.68] {$w_{2,2}$} (hidden-2);

                    \draw [->] (input-3) -- node [sloped, above, pos=0.6] {$w_{3,1}$} (hidden-1);
                    \draw [->] (input-3) -- node [sloped, below, pos=0.6] {$w_{3,2}$} (hidden-2);

                    \draw [->] (input-4) -- node [sloped, above, pos=0.8] {$w_{4,1}$} (hidden-1);
...
%                            output-\j);
                ...
                \draw [line width = 0.0mm, ->] (hidden-1) -- node [midway, sloped, above=0.3mm, pos=0.8] {$v_{1, 2}$} (output-2);
                \draw [line width = 0.0mm, ->] (hidden-2) -- node [midway, sloped, above=0.3mm, pos=0.8] {$v_{1, 1}$} (output-1);
