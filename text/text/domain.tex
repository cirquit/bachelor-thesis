...
%                \caption{Zustandsraum von HFO 1vs1 \label{fig:somelabel}}
            ...
            \subsubsection*{Lagekodierung}
                Die Lagekodierung ist normalisiert auf der maximale diagonale Länge des Spielfelds die durch $max_{l} = \sqrt{l^2 + w^2}$ gegeben ist, wobei $l$ die Länge und $w$ die Breite ist. In dem Fall für HFO, entspricht sie $sqrt(2^2 + 2^2) ~= 2.82$. Die folgenden Formeln sind \\
...
\newpage
            \subsection{Wahrscheinlichkeitsverteilung der Aktionen}
                \begin{multicols}{2}
                    \noindent
...
\newpage
        ...
        \begin{figure}[H]
            \begin{center}
                \includegraphics[scale=0.85]{../pictures/games/actiondist-gameplay.png}\\
                \caption{\label{fig:actiondist-gameplay}}
            \end{center}
        \end{figure}

        In Abbildung \ref{fig:actiondist-gameplay} sehen wir einen vielversprechenden Torversuch von dem Individuum. Leider läuft er einfach nur in den Torwart rein und ihm wird sein Ball abgenommen. Es passiert auch sehr oft, dass 
...
\newpage
        ...
        \begin{figure}[H]
            \begin{center}
                \includegraphics[scale=0.85]{../pictures/games/neural-evo-gameplay.png}\\
                \caption{\label{fig:actiondist-gameplay}}
            \end{center}
        \end{figure}
...
\newpage
        ...
        \subsection{Vergleich} \label{algo-comparisson}
