...
% -------------------------------------------------------------------------------------------------
%
\lmutitle{Kooperative Neuroevolution\\[1mm] in RoboCup2D}  % title
...
\lmuadvisortwo{Lenz Belzner, Dipl.-Medieninf.}    % second advisor's name
...
\definecolor{mylinkcolor}{RGB}{0, 126, 150}
