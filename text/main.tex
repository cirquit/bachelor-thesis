...
% \lmudraftdate{\today}                             % only for versioning during work! (uncomment for final version!)
...
\usepackage{tikz}
\usetikzlibrary{arrows,automata, positioning, calc, shadings, patterns, tikzmark}
